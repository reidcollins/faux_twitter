...
describe "Userpages" do
  ...
  describe "profile page" do
  	let(:user) { FactoryGirl.create(:user) }
    let!(:m1) { FactoryGirl.create(:micropost, :user => user, :content => "micropost1 content") }
    let!(:m2) { FactoryGirl.create(:micropost, :user => user, :content => "micropost2 content") }
  ...
  describe "following/followers" do
    ...
    describe "followed users (following)" do
      ...
      it { should have_selector('title', :text => proper_title('following')) }
    ...
    describe "followers" do
      ...
      it { should have_selector('title', :text => proper_title('followers')) }
